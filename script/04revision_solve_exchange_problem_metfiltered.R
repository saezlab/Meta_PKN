...
meta_network_carnival_ready <- as.data.frame(
  read_csv("Dropbox/Meta_PKN/result/meta_network_carnival_ready_fullomni_metfiltered.csv"))
...
write_csv(meta_network_carnival_ready, "~/Dropbox/Meta_PKN/result/meta_network_carnival_ready_exch_solved_fullomni_metfiltered.csv")
write_tsv(meta_network_carnival_ready, "~/Dropbox/Meta_PKN/result/meta_network_carnival_ready_exch_solved_fullomni_metfiltered.tsv")
