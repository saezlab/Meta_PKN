...
write_csv(meta_network, "Dropbox/Meta_PKN/result/meta_network_fullomni.csv")
...
write_csv(meta_network_carnival_ready, "Dropbox/Meta_PKN/result/meta_network_carnival_ready_fullomni.csv")
